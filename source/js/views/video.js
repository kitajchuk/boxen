    ...
    return `
        <div class="media media--embed">
            <div class="media__wrap">
                <div class="embed js-embed media__node">
                    ...
                    <div class="embed__poster embed__overlay js-embed-poster js-lazy-image -cover -text--center" data-img-src="${imageJson.src}?format=original"></div>
